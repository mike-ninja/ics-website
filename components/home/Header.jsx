...
const Header = () => {
  return (
    <header className="bg-home_header_bg relative bg-cover bg-top lg:bg-[center_top_-15rem] h-[60vh] min-h-[600px] lg:h-[80vh] flex flex-col justify-center items-center">
